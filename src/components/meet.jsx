...
text-transparent xl:text-[5rem] md:text-6xl font-extrabold font-polySans md:max-w-5xl text-center text-[28px] max-w-[375px]">
                    ...
                    <button className="inline-flex justify-center align-middle items-center p-5 text-sm font-medium text-center text-white bg-black rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
